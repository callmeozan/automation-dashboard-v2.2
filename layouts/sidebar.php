        ...
        <div class="relative">
            ...
            <button onclick="toggleDbMenu()" class="nav-item w-full flex justify-between items-center focus:outline-none group <?php echo $is_db_active ? 'text-white bg-slate-800/50' : ''; ?>">
                <div class="flex items-center gap-3">
                    <i class="fas fa-database w-6 group-hover:text-emerald-400 transition <?php echo $is_db_active ? 'text-emerald-400' : ''; ?>"></i>
            ...
            <div id="dbSubmenu" class="<?php echo $is_db_active ? '' : 'hidden'; ?> pl-10 space-y-1 mt-1 bg-slate-900/50 py-2 border-l border-slate-800 ml-3">
                <a href="database.php" class="block text-sm py-1 transition <?php echo ($current_page == 'database.php') ? 'text-emerald-400 font-bold' : 'text-slate-400 hover:text-emerald-400'; ?>">
                    • Machine / Assets
                </a>
                <a href="master_items.php" class="block text-sm py-1 transition <?php echo ($current_page == 'master_items.php') ? 'text-emerald-400 font-bold' : 'text-slate-400 hover:text-emerald-400'; ?>">
                    • Master Items
                </a>
            </div>
        </div>
